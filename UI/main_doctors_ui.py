...
class Ui_Doctors(object):
    def setupUi(self, Doctors):
        ...
        self.wdgt_search_filter_layout.setContentsMargins(-1, 0, 0, 0)
        ...
        self.wdgt_pg_buttons = QtWidgets.QWidget(Doctors)
        self.wdgt_pg_buttons.setObjectName("wdgt_pg_buttons")
        self.wdgt_pg_buttons_layout = QtWidgets.QHBoxLayout(self.wdgt_pg_buttons)
        self.wdgt_pg_buttons_layout.setContentsMargins(-1, 0, 0, 0)
        self.wdgt_pg_buttons_layout.setSpacing(10)
        self.wdgt_pg_buttons_layout.setObjectName("wdgt_pg_buttons_layout")
        self.pshbtn_add = QtWidgets.QPushButton(self.wdgt_pg_buttons)
        ...
        self.pshbtn_edit = QtWidgets.QPushButton(self.wdgt_pg_buttons)
        ...
        self.pshbtn_archive = QtWidgets.QPushButton(self.wdgt_pg_buttons)
        ...
        self.main_layout.addWidget(self.wdgt_pg_buttons)
